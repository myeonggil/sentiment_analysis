...
with tf.name_scope('layer1') as scope:
    W1 = tf.get_variable('W1', [200, 162], initializer=tf.contrib.layers.xavier_initializer())
    b1 = tf.Variable(tf.random_normal([162]))
...
with tf.name_scope('layer2') as scope:
    W2 = tf.get_variable('W2', [162, 128], initializer=tf.contrib.layers.xavier_initializer())
...
with tf.name_scope('layer3') as scope:
    W3 = tf.get_variable('W3', [128, 98], initializer=tf.contrib.layers.xavier_initializer())
...
with tf.name_scope('layer4') as scope:
    W4 = tf.get_variable('W4', [98, 72], initializer=tf.contrib.layers.xavier_initializer())
    b4 = tf.Variable(tf.random_normal([72]))
...
with tf.name_scope('layer5') as scope:
    W5 = tf.get_variable('W5', [72, 50], initializer=tf.contrib.layers.xavier_initializer())
...
with tf.name_scope('layer6') as scope:
    W6 = tf.get_variable('W6', [50, 32], initializer=tf.contrib.layers.xavier_initializer())
...
with tf.name_scope('layer8') as scope:
    W8 = tf.get_variable('W8', [32, 18], initializer=tf.contrib.layers.xavier_initializer())
    b8 = tf.Variable(tf.random_normal([18]))
...
with tf.name_scope('layer9') as scope:
    W9 = tf.get_variable('W9', [18, 8], initializer=tf.contrib.layers.xavier_initializer())
    b9 = tf.Variable(tf.random_normal([8]))
...
with tf.name_scope('layer10') as scope:
    W10 = tf.get_variable('W10', [8, 2], initializer=tf.contrib.layers.xavier_initializer())
...
writer = tf.summary.FileWriter('./result_logs6')
