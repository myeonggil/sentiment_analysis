...
for i in range(4, 5):
    # pos_review = open('./../../data/test_pos_review/test_pos_review%d.txt' % i, 'r', encoding='utf-8')
    ...
    pos_csv = open('./../../data/pos_word_weight.csv', 'r', encoding='utf-8')

    pos_data = csv.reader(pos_csv)
    ...
    for x in pos_data:
        ...
        if count % 290 == 0:
            print('pos : %d' % int(count / 290), '%')
        count += 1

    print('pos review score : ', neg_score)
