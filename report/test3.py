...
W1 = tf.get_variable('W1', [200, 400], initializer=tf.contrib.layers.xavier_initializer())
b1 = tf.Variable(tf.random_normal([400]))
L1 = tf.nn.relu(tf.add(tf.matmul(X, W1), b1))

W2 = tf.get_variable('W2', [400, 800], initializer=tf.contrib.layers.xavier_initializer())
b2 = tf.Variable(tf.random_normal([800]))
L2 = tf.nn.relu(tf.add(tf.matmul(L1, W2), b2))

W3 = tf.get_variable('W3', [800, 1600], initializer=tf.contrib.layers.xavier_initializer())
b3 = tf.Variable(tf.random_normal([1600]))
L3 = tf.nn.relu(tf.add(tf.matmul(L2, W3), b3))

W4 = tf.get_variable('W4', [1600, 3200], initializer=tf.contrib.layers.xavier_initializer())
b4 = tf.Variable(tf.random_normal([3200]))
L4 = tf.nn.relu(tf.add(tf.matmul(L3, W4), b4))

W5 = tf.get_variable('W5', [3200, 3200], initializer=tf.contrib.layers.xavier_initializer())
b5 = tf.Variable(tf.random_normal([3200]))
L5 = tf.nn.relu(tf.add(tf.matmul(L4, W5), b5))

W6 = tf.get_variable('W6', [3200, 3200], initializer=tf.contrib.layers.xavier_initializer())
b6 = tf.Variable(tf.random_normal([3200]))
L6 = tf.nn.relu(tf.add(tf.matmul(L5, W6), b6))


W7 = tf.get_variable('W7', [3200, 3200], initializer=tf.contrib.layers.xavier_initializer())
b7 = tf.Variable(tf.random_normal([3200]))
L7 = tf.nn.relu(tf.add(tf.matmul(L6, W7), b7))

W8 = tf.get_variable('W8', [3200, 3200], initializer=tf.contrib.layers.xavier_initializer())
b8 = tf.Variable(tf.random_normal([3200]))
L8 = tf.nn.relu(tf.add(tf.matmul(L7, W8), b8))

W9 = tf.get_variable('W9', [3200, 3200], initializer=tf.contrib.layers.xavier_initializer())
b9 = tf.Variable(tf.random_normal([3200]))
L9 = tf.nn.relu(tf.add(tf.matmul(L8, W9), b9))

W10 = tf.get_variable('W10', [3200, 2], initializer=tf.contrib.layers.xavier_initializer())
