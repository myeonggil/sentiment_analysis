...
W1 = tf.get_variable('W1', [200, 300], initializer=tf.contrib.layers.xavier_initializer())
b1 = tf.Variable(tf.random_normal([300]))
L1 = tf.nn.relu(tf.add(tf.matmul(X, W1), b1))

W2 = tf.get_variable('W2', [300, 400], initializer=tf.contrib.layers.xavier_initializer())
b2 = tf.Variable(tf.random_normal([400]))
L2 = tf.nn.relu(tf.add(tf.matmul(L1, W2), b2))

W3 = tf.get_variable('W3', [400, 500], initializer=tf.contrib.layers.xavier_initializer())
b3 = tf.Variable(tf.random_normal([500]))
L3 = tf.nn.relu(tf.add(tf.matmul(L2, W3), b3))

W4 = tf.get_variable('W4', [500, 600], initializer=tf.contrib.layers.xavier_initializer())
b4 = tf.Variable(tf.random_normal([600]))
L4 = tf.nn.relu(tf.add(tf.matmul(L3, W4), b4))

W5 = tf.get_variable('W5', [600, 700], initializer=tf.contrib.layers.xavier_initializer())
b5 = tf.Variable(tf.random_normal([700]))
L5 = tf.nn.relu(tf.add(tf.matmul(L4, W5), b5))

W6 = tf.get_variable('W6', [700, 800], initializer=tf.contrib.layers.xavier_initializer())
b6 = tf.Variable(tf.random_normal([800]))
L6 = tf.nn.relu(tf.add(tf.matmul(L5, W6), b6))

W7 = tf.get_variable('W7', [800, 900], initializer=tf.contrib.layers.xavier_initializer())
b7 = tf.Variable(tf.random_normal([900]))
L7 = tf.nn.relu(tf.add(tf.matmul(L6, W7), b7))

W8 = tf.get_variable('W8', [900, 1000], initializer=tf.contrib.layers.xavier_initializer())
b8 = tf.Variable(tf.random_normal([1000]))
L8 = tf.nn.relu(tf.add(tf.matmul(L7, W8), b8))

W9 = tf.get_variable('W9', [1000, 1100], initializer=tf.contrib.layers.xavier_initializer())
b9 = tf.Variable(tf.random_normal([1100]))
L9 = tf.nn.relu(tf.add(tf.matmul(L8, W9), b9))

W10 = tf.get_variable('W10', [1100, 2], initializer=tf.contrib.layers.xavier_initializer())
...
saver = tf.train.Saver()
save_path = saver.save(sess, './word_learning_result6.ckpt')